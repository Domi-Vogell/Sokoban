...
const Kopf = function( obj ){    
    ...
    const matAuge = new THREE.MeshBasicMaterial( { color: 0xDDDDDD } );
    ...
    const matnase = new THREE.MeshBasicMaterial( { color: 0xff8800 } );
    ...
    const material = new THREE.MeshBasicMaterial( { color: 0xEA899A } );
